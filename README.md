<h1> US Labor Statistics Dashboard</h1>
...
Compares Average Annual Wages across different sectors to identify high-paying industries.<br/>
Visualizes total Employees by Industry to highlight the largest employment sectors.<br/>
Trend Analysis (2017-2020):Tracks the year-over-year progression of Wages vs. Employment counts.<br/>
Helps identify macro-economic trends, such as wage stagnation or employment booms.<br/>
Geographic & Demographic Insights: State-by-State Comparison: Detailed breakdown of employment metrics for each state.<br/>
Population Normalization: Includes a calculated metric for Employees per 1,000 Capita, allowing for fair comparisons between large states (like CA, TX) and smaller ones.<br/>
